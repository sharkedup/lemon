...
private let allForms: [Fruit] = [
    ...
    .runner, .princess, .donut, .apple, .greenApple, .coolLemon, .tennisBall, .daisy, .soccerBall
]
...
#Preview("Soccer Ball — Detail") {
    ContentView(previewForm: .soccerBall, previewAwake: true)
        .lemonCharacter
        .frame(width: 420, height: 420)
        .background(Color(red: 0.98, green: 0.98, blue: 0.92))
}
